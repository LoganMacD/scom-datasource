...
## SCOM Reference
- **Do not modify anything inside the `SQL SCHEMA` folder.** It is a reference for you to use to ensure you have the correct schema assumptions when you are making queries for SCOM.